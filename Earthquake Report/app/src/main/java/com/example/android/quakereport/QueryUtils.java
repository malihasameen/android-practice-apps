...
public final class QueryUtils {
    ...
    private static List<Earthquake>  extractEarthquakes (String jsonResponse){
        ...
        try {
            ...
            int totalEarthquake = earthquakeArray.length();

            for (int index = 0; index < totalEarthquake; index++) {

                JSONObject currentEarthquake = earthquakeArray.getJSONObject(index);
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestURL){
        ...
        // Make an HTTP request to the URL and get the JSON response
        ...
        // Parse the JSON response and create list of Earthquakes
